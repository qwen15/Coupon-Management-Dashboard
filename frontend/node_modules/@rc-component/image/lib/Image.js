...
const ImageInternal = props => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", _extends({}, otherProps, {
    className: (0, _classnames.default)(prefixCls, rootClassName, classNames.root, {
    ...
    className: (0, _classnames.default)(`${prefixCls}-cover`, classNames.cover, `${prefixCls}-cover-${coverPlacement}`),
    style: {
    ...
    styles: styles?.popup,
    rootClassName: (0, _classnames.default)(previewRootClassName, rootClassName)
  })));
};
