...
function Footer(props) {
  ...
  const renderOperation = ({
    ...
    return /*#__PURE__*/React.createElement("div", {
      key: type,
      className: (0, _classnames.default)(actionCls, `${actionCls}-${type}`, {
  ...
  const actionsNode = /*#__PURE__*/React.createElement("div", {
    className: (0, _classnames.default)(`${prefixCls}-actions`, classNames.actions),
    style: styles.actions
  }, flipYNode, flipXNode, rotateLeftNode, rotateRightNode, zoomOutNode, zoomInNode);

  // >>>>> Render
  return /*#__PURE__*/React.createElement("div", {
    className: (0, _classnames.default)(`${prefixCls}-footer`, classNames.footer),
    style: styles.footer
