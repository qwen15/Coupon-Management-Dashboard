...
const CollapsePanel = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const iconNode = iconNodeInner && /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({
    className: (0, _classnames.default)(`${prefixCls}-expand-icon`, customizeClassNames?.icon),
    style: styles?.icon
  }, ['header', 'icon'].includes(collapsible) ? collapsibleProps : {}), iconNodeInner);
  const collapsePanelClassNames = (0, _classnames.default)(`${prefixCls}-item`, {
    [`${prefixCls}-item-active`]: isActive,
    [`${prefixCls}-item-disabled`]: disabled
  }, className);
  const headerClassName = (0, _classnames.default)(headerClass, `${prefixCls}-header`, {
  ...
  return /*#__PURE__*/_react.default.createElement("div", (0, _extends2.default)({}, resetProps, {
    ...
    className: (0, _classnames.default)(`${prefixCls}-title`, customizeClassNames?.title),
    style: styles?.title
