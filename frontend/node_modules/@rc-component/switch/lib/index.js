...
const Switch = /*#__PURE__*/React.forwardRef(({
  ...
  const switchClassName = (0, _classnames.default)(prefixCls, className, {
  ...
  return /*#__PURE__*/React.createElement("button", _extends({}, restProps, {
    ...
    className: (0, _classnames.default)(`${prefixCls}-inner-checked`, switchClassNames?.content),
    style: styles?.content
  }, checkedChildren), /*#__PURE__*/React.createElement("span", {
    className: (0, _classnames.default)(`${prefixCls}-inner-unchecked`, switchClassNames?.content),
    style: styles?.content
  }, unCheckedChildren)));
});
