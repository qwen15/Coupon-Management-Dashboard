...
const InternalSubMenu = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  // >>>>> List node
  let listNode = /*#__PURE__*/React.createElement(_rcOverflow.default.Item, _extends({
    ref: ref,
    role: "none"
  }, restProps, {
    component: "li",
    style: style,
    className: (0, _classnames.default)(subMenuPrefixCls, `${subMenuPrefixCls}-${mode}`, className, {
